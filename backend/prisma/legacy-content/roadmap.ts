...
const frontendRoadmap: Roadmap = {
  ...
  description:
    'Проходите стадии по порядку — разберётесь от базовых веб-технологий до современных фреймворков, TypeScript, тестирования и SSR.',
  ...
  stages: [
      ...
      nodes: [
        n(
          ...
          [
            ...
            r(
              'Введение: браузер и клиент-сервер',
            ...
            r(
              'Хекслет: основы веб-разработки',
              'https://ru.hexlet.io/courses/web_basics',
              'Хекслет'
            ),
        ...
        n(
          ...
          [
            ...
            r(
              'HTTP-методы: GET, POST и другие',
              'https://developer.mozilla.org/ru/docs/Web/HTTP/Methods',
              'MDN'
            ),
            r(
              'Fetch и сетевые методы',
              'https://learn.javascript.ru/network',
              'learn.javascript.ru'
            ),
            r(
              'HTTP: коды состояний и заголовки',
        ...
        n(
          ...
          [
            ...
            r(
              'Как работают браузеры — подробно',
      ...
      nodes: [
        n(
          ...
          [
            ...
            r(
              'Хекслет: основы HTML',
              'https://ru.hexlet.io/courses/introduction_to_html',
              'Хекслет'
            ),
            r(
              'Изучение HTML — MDN Learn',
        ...
        n(
          ...
          [
            ...
            r(
              'Доступность — большой гайд',
              'https://htmlacademy.ru/blog/boost/frontend/accessibility',
              'HTML Academy'
            ),
            r('A11Y-основы на web.dev', 'https://web.dev/learn/accessibility', 'web.dev', 'en'),
            r(
              'WCAG 2.1 — рекомендации W3C',
      ...
      nodes: [
        ...
        n(
          ...
          [
            ...
            r(
              'CSS Custom Properties — полный гайд',
    ...
    },
    {
      ...
      nodes: [
        ...
        n('js-oop', 'ООП и прототипы', 'Классы, наследование, this, bind/call/apply.', 'optional', [
    ...
    },
    {
      ...
      nodes: [
        n('git-basics', 'Основы Git', 'commit, branch, merge, rebase, reset, revert.', 'required', [
          r(
            'Интерактивный курс Learn Git Branching',
        ...
        n(
          ...
          [
            ...
            r(
              'GitHub Flow — визуально',
              'https://docs.github.com/ru/get-started/using-github/github-flow',
              'GitHub Docs'
            ),
            r(
              'Git Hello World — GitHub Docs',
        ...
        n(
          ...
          [
            r(
              ...
              'https://docs.github.com/ru/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests',
              'GitHub Docs'
            ),
            r(
    ...
    },
    {
      ...
      nodes: [
        n('npm', 'npm', 'Команды, package.json, semantic versioning, lock-файл.', 'required', [
      ...
      nodes: [
        n(
          ...
          [
            ...
            r(
              'Ваш первый компонент — React.dev',
        ...
        n(
          ...
          [
            r(
              'Документация Vue 3 на русском',
              'https://ru.vuejs.org/guide/introduction.html',
              'Vue.js RU'
            ),
            r(
              'Composition API — ру-гайд',
              'https://ru.vuejs.org/guide/extras/composition-api-faq.html',
              'Vue.js RU'
            ),
            r(
              'Pinia — состояние для Vue',
      ...
      nodes: [
        ...
        n(
          ...
          [
            ...
            r(
              'TypeScript-плагин для CSS Modules',
              'https://github.com/mrmckeb/typescript-plugin-css-modules',
              'GitHub',
              'en'
            ),
            r(
              'webpack-конфиг для CSS Modules',
        ...
        n('bem', 'BEM-методология', 'Именование классов в «обычном» CSS.', 'optional', [
    ...
    },
    {
      ...
      nodes: [
        ...
        n('redux', 'Redux Toolkit', 'Классика с чёткими паттернами и DevTools.', 'alternative', [
          r(
    ...
    },
    {
      ...
      nodes: [
        ...
        n('cypress', 'Cypress', 'e2e с удобным UI и time-travel-отладкой.', 'optional', [
          r(
        ...
        n(
          ...
          [
            ...
            r(
              ...
              'https://web.dev/articles/serve-images-webp?hl=ru',
              'web.dev'
            ),
            r(
              'srcset и sizes',
              'https://developer.mozilla.org/ru/docs/Web/HTML/Element/img#srcset',
              'MDN'
            ),
            r(
              'Использование AVIF в продакшене',
    ...
    },
    {
      ...
      nodes: [
        ...
        n('xss', 'XSS и CSRF', 'Как их эксплуатируют и как защищаться.', 'required', [
          ...
          r(
            'XSS — MDN',
            'https://developer.mozilla.org/ru/docs/Glossary/Cross-site_scripting',
            'MDN'
          ),
          r(
    ...
    },
    {
      ...
      nodes: [
        ...
        n('nuxt', 'Nuxt', 'Next.js, только для Vue.', 'alternative', [
          r(
            'Документация Nuxt',
      ...
      nodes: [
        ...
        n(
          ...
          [
            ...
            r(
              'Manifest — официальная спецификация',
        ...
        n(
          ...
          [
            r(
              'Web Components на MDN',
              'https://developer.mozilla.org/ru/docs/Web/API/Web_components',
              'MDN'
            ),
            r(
              'Custom Elements — MDN',
